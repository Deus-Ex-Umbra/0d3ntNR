...
async function bootstrap() {
  ...
  app.enableCors({
    origin: ['http://localhost:5173', 'http://localhost:3000', 'http://192.168.0.5:5173', 'http://192.168.0.5:3000', 'http://localhost:64576', 'http://192.168.0.5:64576', 'http://26.249.46.210:64576'],
    credentials: true,
  });
